...
import {addToNewsletter} from "../../../../../helpers/api/addToNewsletter";
import {useState} from "react"
import Loader from "../../../../ui/globals/Loading";
export default function EmailBox() {
    ...
    const handleSubmit = async (e) => {
       ...
       await addToNewsletter(email,setIsLoading,setEmail);
    };
    return (
        <div>
            <form onSubmit={handleSubmit} className="flex gap-3">
                ...
                <Button type="submit" color="blue" size="auto" className={'!rounded-[100px] !px-8'}>
                    {isLoading ? <Loader /> : 'ثبت'}
                </Button>
            </form>
