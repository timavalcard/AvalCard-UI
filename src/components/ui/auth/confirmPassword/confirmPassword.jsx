...
export default function ConfirmationPassword({next, step, pre}) {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="grid grid-cols-12">
        ...
        <div className={`${styles.loginSignup}`}>
                ...
                <div className='mt-8'>
                    <p className='text-very-bold'>لطفا رمز عبور جدید خود را وارد کنید</p>
                </div>
                ...
                <p className='mt-6 text-very-bold'>کد تایید پیامک شده را وارد کنید:</p>
