...
import ClientContent from "../../panel/buy-deliver-iran/ClientContent";
export const dynamic = 'force-dynamic';
export async function generateMetadata() {
    const { data: page } = await fetchPageContent("buy-deliver-iran");
...
const questions = {
    q1: {
        title: 'چگونه می‌توانم از سایت‌های خارجی مانند آمازون انگلیس خرید کنم؟',
        description: 'برای خرید از وب‌سایت‌هایی مانند Amazon UK، باید از خدمات واسطه یا آدرس بین‌المللی استفاده کنید، چراکه بسیاری از این سایت‌ها ارسال مستقیم به ایران ندارند.'
    },
    q2: {
        title: 'آیا می‌توانم با کارت بانکی ایرانی از سایت‌های خارجی خرید کنم؟',
        description: 'خیر، کارت‌های بانکی ایرانی در سایت‌های خارجی قابل استفاده نیستند. برای خرید نیاز به کارت‌های بین‌المللی مانند Visa یا MasterCard دارید یا باید از خدمات پرداخت واسطه‌ای استفاده کنید.'
    },
    q3: {
        title: 'چگونه می‌توانم از قیمت نهایی محصول (با هزینه حمل و گمرک) مطلع شوم؟',
        description: 'در قسمت ثبت سفارش در صورت وارد کردن وزن کالا مبلغ حمل و نقل برایتان نمایش داده میشود.'
    },
    q4: {
        title: 'آیا خرید از آمازون انگلیس شامل مالیات می‌شود؟',
        description: 'بله، در بیشتر مواقع قیمت کالا در آمازون انگلیس شامل مالیات محلی است. همچنین اگر ارسال بین‌المللی داشته باشد، هزینه‌های گمرکی کشور مقصد نیز محاسبه خواهد شد.'
    },
    q5: {
        title: 'چه مدت طول می‌کشد تا کالا از سایت خارجی به دستم برسد؟',
        description: 'بسته به کالا و مقصد بین ۴۰ تا ۶۰ روز کاری'
    },
    q6: {
        title: 'آیا امکان بازگشت یا مرجوعی کالا وجود دارد؟',
        description: 'بازگشت کالا از ایران به سایت‌های خارجی دشوار و هزینه‌بر است، بنابراین بهتر است پیش از خرید، مشخصات کامل کالا را بررسی کنید.'
    },
    q7: {
        title: 'کالاهایی که از خارج می‌خرم شامل گارانتی می‌شوند؟',
        description: 'معمولاً گارانتی کالاهای خارجی در ایران معتبر نیست، مگر اینکه نمایندگی رسمی در کشور داشته باشند.'
    },
    q8: {
        title: 'آیا خرید از سایت‌های خارجی مقرون‌به‌صرفه است؟',
        description: 'برای برخی کالاها مانند لوازم الکترونیکی خاص، برندهای خاص لباس یا کالاهایی که در ایران نایاب‌اند، ممکن است خرید از خارج به‌صرفه‌تر یا تنها گزینه باشد، ولی باید هزینه‌های اضافی را نیز در نظر بگیرید.'
    }
};
...
export default async function page() {
    ...
    return (
        <>
            <div className="container">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-7 items-stretch mt-5">
                    ...
                    <div className="">
                        ...
                        <TitleWithBlue>
                              خرید مطمئن از <strong className="text-blue-custom"> وب‌سایت‌های معتبر خارجی؛ </strong> ساده، سریع، حرفه‌ای
                        
                        </TitleWithBlue>

                        <p className="leading-7 mt-7 text-sm text-[#191919] opacity-50">با خدمات خرید بین‌المللی ما، می‌توانید کالاهای مورد نیاز خود را از وب‌سایت‌های معتبری مانند Amazon، eBay، AliExpress و سایر فروشگاه‌های جهانی تهیه نمایید.
                            تمام مراحل از ثبت سفارش تا تحویل در ایران، توسط تیم ما به‌صورت کامل و با شفافیت کامل انجام می‌شود.
                            کالای اصل، پرداخت امن و پشتیبانی مستمر؛ تجربه‌ای مطمئن از خرید مستقیم از خارج را با ما داشته باشید.
                        </p>

                        <div className="flex sm:gap-6 gap-3 mt-10">
                            <Button flex size="auto" href="/panel/buy-deliver-iran">
                                <div>
                    ...
                    <div className="relative md:mt-0 mt-7">
                        <img loading="lazy" fill src="/images/buy-deliver-iran.webp" alt="خرید از وب سایت های خارجی" className="w-full" />
                    </div>
            ...
            <ClientContent   baseUrl={"buy-deliver-iran"} categories={categories} />
