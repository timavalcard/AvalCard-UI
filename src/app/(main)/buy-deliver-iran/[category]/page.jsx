...
import GiftCards from "../../gift-card/[category]/GiftCards";
    ...
    return (
        <>
            <div className="container">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-7 items-stretch mt-5">
                    ...
                    <div className="">
                        ...
                        <div className="flex sm:gap-6 gap-3 mt-10">
                            <Button flex size="auto" href={`/panel/buy-deliver-iran#gift-card-box-${categoryData.id}`}>
                                <div>
                ...
                <Account categoryData={categoryData} category={categoryData.products}/>
            </div>
