...
import BuyAcconts from "./Account";
    ...
    return (
        ...
        <>
            ...
            <div className="container">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-7 items-center mt-5 mb-7">

                    <div className="">
                        <TitleWithBlue className={'!mt-0'}>
                            {product.title}
                        </TitleWithBlue>

                        <p className="text-blue-custom mt-7 text-lg font-semibold">
                        خرید از اول کارت یه چیز دیگست!
                        </p>
                        <p className="leading-8 mt-7 text-sm opacity-50">
                            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.
                        </p>
                        ...
                        <div className="flex sm:gap-6 gap-3 mt-10">
                            <Button flex size="auto" href={product.url}>
                                <div>
                    ...
                    <div className="relative md:mt-0 mt-7">
                        <img loading="lazy" fill src={product.media?.url} alt={product.media?.title} className="w-full rounded-lg" />
                    </div>

                </div>

                <Des content={product.content} />

                <BuyAcconts related_products={related_products} />
            </div>
