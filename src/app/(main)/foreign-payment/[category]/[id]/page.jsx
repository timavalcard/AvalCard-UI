        ...
        <>
            ...
            <div className="container">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-7 items-center mt-5 mb-7">
                    ...
                    <div className="">
                        <TitleWithBlue className={'!mt-0'}>{product.title}</TitleWithBlue>

                        <p className="text-blue-custom mt-7 text-lg font-semibold">
                          خرید از سایت های خارجی و تحویل در سریع ترین زمان ممکن
                        </p>
                        <p className="leading-8 mt-7 text-sm opacity-50" dangerouslySetInnerHTML={{__html:product.excerpt}}></p>
                ...
                <BuyAcconts related_products={related_products} id={product.id} />
            </div>
